...
export const CITATIONS: Citation[] = [
  ...
  { id: 'fusionlevels', label: 'Int. J. Image and Data Fusion 2010', citation: 'International Journal of Image and Data Fusion (2010). The processing levels of multi-source data fusion: observation (pixel), feature, and decision level.', doi: '10.1080/19479830903561035' },
  { id: 'dasymetric', label: 'Geography Compass 2009 (dasymetric mapping)', citation: 'Geography Compass (2009). Dasymetric mapping: redistributing aggregate quantities onto ancillary geometry (e.g. disaggregating population by built structure).', doi: '10.1111/j.1749-8198.2009.00220.x' },
  { id: 'vdatum', label: 'NOAA VDatum', citation: 'NOAA National Geodetic Survey. VDatum: vertical-datum transformations (ellipsoidal, orthometric/geoid, tidal) for harmonizing heights across heterogeneous sources.', url: 'https://vdatum.noaa.gov/docs/datums.html' },
];
